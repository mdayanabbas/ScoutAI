...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_companies_normalized_domain"),
        "companies",
        ["normalized_domain"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_company_pages_company_id"),
        "company_pages",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_company_pages_page_type"),
        "company_pages",
        ["page_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_jobs_normalized_title"),
        "jobs",
        ["normalized_title"],
        unique=False,
    )
    op.create_index(
        op.f("ix_jobs_remote_type"), "jobs", ["remote_type"], unique=False
    )
    op.create_index(
        op.f("ix_jobs_role_category"), "jobs", ["role_category"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_tech_stack_items_company_id"),
        "tech_stack_items",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_tech_stack_items_name"),
        "tech_stack_items",
        ["name"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_runs_company_id"),
        "agent_runs",
        ["company_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_runs_job_id"), "agent_runs", ["job_id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_tech_stack_items_company_id"), table_name="tech_stack_items"
    )
    ...
    op.drop_index(op.f("ix_company_pages_page_type"), table_name="company_pages")
